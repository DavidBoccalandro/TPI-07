...
void buscarTesoros (int &monedasAcum, int &llaveGuardada, int&ronda){
     ...
     if (obtuvoLlave( p, ronda) ){    //caso exitoso
            ...
            if(opcionVender == 'V'){
                ...
                cout<<"ï¿½Que llave desea guardar?"<<endl;
